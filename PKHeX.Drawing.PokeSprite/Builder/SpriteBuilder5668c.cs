...
public sealed class SpriteBuilder5668c : SpriteBuilder
{
    ...
    protected override SKBitmap GetEggSprite(ushort species) => species == (int)Species.Manaphy ? ImageUtil.GetSKBitmap(Resources.b_490_e) : ImageUtil.GetSKBitmap(Resources.b_egg);
    ...
    public override SKBitmap ItemTM => ImageUtil.GetSKBitmap(Resources.bitem_tm);
